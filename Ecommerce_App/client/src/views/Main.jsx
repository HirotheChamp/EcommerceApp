...
return (
    <><nav className="navbar navbar-expand-lg navbar-light mt-2 mx-5">


        <a className="navbar-brand p-2" href="#">EcommerceApp</a>
        <div className="d-flex navbar-nav mr-auto mt-2 mt-lg-0">

            <a className="nav-link p-2" href="#">Home <span className="sr-only">(current)</span></a>


            <a className="nav-link p-2" href="#">Orders</a>


            <a className="nav-link p-2" href="#">Profile</a>




            <a href="/login"><i className="fa fa-user ml-auto p-2 float-right" style={{color: "black", fontSize:"20px"}}></i></a>
        </div>
    </nav><hr></hr><div className="container">
